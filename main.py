...
class Enemy(Ship):
    ...
    def move(self, vel):
        self.y += vel # enemy only moves down
...
def main():
    ...
    player_vel = 10 # velocity (move 10px)
    ...
    def redraw_window():
        ...
        if lost:
            ...
            WIN.blit(lost_label, (WIDTH/2 - lost_label.get_width()/2, 350)) # center of the screen
    ...
    while run: 
        ...
        if len(enemies) == 0:
            level += 1
            wave_length += 5
            for i in range(wave_length):                                        #(-1500*level/5,-100)
